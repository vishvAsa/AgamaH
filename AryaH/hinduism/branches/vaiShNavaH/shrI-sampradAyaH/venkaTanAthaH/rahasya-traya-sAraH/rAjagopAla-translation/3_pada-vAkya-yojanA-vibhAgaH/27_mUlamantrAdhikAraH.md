...
From the letter ’ņā’ one acquires the desire to praise the Lord and the command of language necessary for praising Him. The letter ‘ya’ causes dread in (the minds) of Yakṣas, Rākṣasas, Vethala, and goblins (bhūtas). Those that know the mantras have thus described the function of the different letters ".
