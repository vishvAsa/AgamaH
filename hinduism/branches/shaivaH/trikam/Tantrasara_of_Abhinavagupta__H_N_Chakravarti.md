...
The letters "sa,” “ṣa," and "sa" are created from the threefold division of will (iccha). From visarga, "ha" is born, and the let ter "kṣa" arises from the union of two consonants: "ha" and "sa." Thus, the Lord who is supreme (anuttara) becomes the 'Lord of the group of letters' (Kuleśvara). It is this single kauliki visarga Śakti 23 of the Lord, which as the flow of vibrating impulse in the form of reflective cognition (parāmarśa) such as groups of letters, etc., extends from ananda to external manifestation and assumes the form of the external principles (tattvas). Visarga is threefold,24 that is, āṇava, which is the restful state of citta; śākta, character ized by the awakening of citta; and sāmvabha, which is the dis solution of citta. 
